...
METHOD populateextcustomfromorder.
  ...
  LOOP AT lt_services ASSIGNING FIELD-SYMBOL(<ls_service>).
    ...
    " If ExtCustom exists AND all fields are populated, skip this service
    IF lt_extcustom IS NOT INITIAL.
      ...
      IF ls_extcustom-wdplantnr IS NOT INITIAL
        ...
        " All fields already populated - skip to next service
        CLEAR lt_extcustom.
        CONTINUE.
      ENDIF.
    ENDIF.
    ...
    " =========================================================================
    " Only continue if fields need population
    " =========================================================================

    " Get ALL fields from order object in ONE query
...
*      ENDIF.
  ...
  DATA: lt_ext_create    TYPE TABLE FOR CREATE /plce/r_pdservice\_extcustom,
        lt_ext_update    TYPE TABLE FOR UPDATE /plce/r_pdservice\\extcustom,
        lt_service_uuids TYPE TABLE OF /plce/r_pdservice-ServiceUUID,
        ...
        lv_check_tour    TYPE sysuuid_x16.
    ...
    ELSE.
      ...
      IF lt_service_uuids IS NOT INITIAL.
        ...
        IF lt_tour_uuids IS NOT INITIAL.
          ...
          " ✅ Call GenerateGeoRoute action (NOT in LOCAL MODE - it's a different entity)
          MODIFY ENTITIES OF /plce/r_pdtour
            ENTITY tour
