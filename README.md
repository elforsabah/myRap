    ...
    return PageController.extend("com.prologa.zwrweighbrigefinal.ext.main.Main", {
        ...
        onNextStep: function () {
            ...
            if (sStepId === "step1") {
                ...
                sContractId = sContractId.padStart(9, '0');
               // sContractId = sContractId.padStart(10, '0');
                ...
                var oListBinding = oModel.bindList("/ZI_WR_R_WEIGHBRIDGE", undefined, undefined, new Filter("IDCardNr", FilterOperator.EQ, sContractId), { $$ownRequest: true });
        ...
        onNextFromK: function () {
            ...
            sKorselsnr = sKorselsnr.padStart(4, '0');
