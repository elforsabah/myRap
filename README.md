CLASS lhc_zi_lanf_root DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS createlanf FOR FUNCTION
      IMPORTING keys FOR FUNCTION lanfroot~createlanf RESULT result.  // Alias~function
    ...
    METHODS map_positions_to_contract
      ...
      CHANGING  ct_order_items   TYPE TABLE OF bapisditm  // Correct type
                ct_order_itemsx  TYPE TABLE OF bapisditmx  // Correct type
