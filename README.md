METHOD touranBMSfreigeben.
  ...
  "=======================================================================
  " STEP 3 — Read service headers directly from the root entity
  "           /PLCE/R_PDService IS a root entity — read it directly
  "           using the ServiceUUIDs collected from lt_asgmts.
  "           Reading via /PLCE/R_PDTourServiceAsgmt is invalid because
  "           it is a child composition entity with no behavior definition.
  "=======================================================================
  READ ENTITIES OF /PLCE/R_PDService IN LOCAL MODE
    ENTITY Service
      FIELDS ( ServiceUUID
               ...
               AdditionalText
               FunctionalLocation )
      WITH VALUE #( FOR ls IN lt_asgmts
                    ( ServiceUUID = ls-ServiceUUID ) )
    RESULT DATA(lt_services)
    FAILED DATA(lt_failed_svc).

  "=======================================================================
  " STEP 4 — Bulk SELECT from EWA_ORDER_OBJECT
  "           Key: POBJNR = ReferenceInternalId from PROLOGA service
  ...
  LOOP AT lt_tours INTO DATA(ls_tour).
    ...
    "     Empty team is valid per interface doc — BMS leaves order
    ...
    LOOP AT lt_tour_asgmts INTO DATA(ls_asgmt).
      ...
      " Corresponding EWA order row — joined via POBJNR = ReferenceInternalId
      ...
      "     Scans both ORDERTXT (EWA) and AdditionalText (PROLOGA)
