METHOD touranBMSfreigeben.
  ...
  "           Sorted by TourUUID + TourSequence for the inner LOOP WHERE.
  "=======================================================================
  READ ENTITIES OF /PLCE/R_PDTour IN LOCAL MODE
  ...
  "=======================================================================
  " STEP 3 — Read service data from base table /plce/tpdsrv
  "           SELECT used because READ ENTITIES of a foreign root entity
  "           is forbidden inside the Tour behavior handler.
  "=======================================================================
  ...
  LOOP AT lt_tours INTO DATA(ls_tour).
    ...
    LOOP AT lt_asgmts INTO DATA(ls_asgmt)
      ...
      "---------------------------------------------------------------------
      " READ TABLE replaces VALUE ty( OPTIONAL (...) ) throughout.
      " When the key is not found the target stays initial (empty structure)
      " which is the correct default behaviour for all lookups here.
      "---------------------------------------------------------------------
      ...
      "           camelCase produces collConsignmentNoteNr
