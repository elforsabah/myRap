Empty. So there is no data source for the facility anywhere — approvals empty, facility/EWC catalog empty. WDF cannot be defaulted. Only RE.

Continue from step 2 with this code instead:
