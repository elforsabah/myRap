    ...
    <edmx:DataServices>
        <Schema Namespace="com.sap.gateway.srvd.zsb_wr_weighingbrige.v0001" Alias="SAP__self">
            ...
            <Action Name="setloadType" EntitySetPath="_it" IsBound="true">
                ...
                <Parameter Name="cardid" Type="Edm.String" Nullable="false" MaxLength="10"/>
            ...
            <Annotations Target="SAP__self.setloadType(SAP__self.ZI_WR_WEIGHINGSESSIONType)/cardid">
                <Annotation Term="SAP__common.Label" String="Sales Document"/>
                <Annotation Term="SAP__common.Heading" String="Sales Doc."/>
            </Annotations>
            ...
            <Annotations Target="SAP__self.identifyCard(SAP__self.ZI_WR_WEIGHINGSESSIONType)/cardid">
                <Annotation Term="SAP__common.Label" String="Sales Document"/>
                <Annotation Term="SAP__common.Heading" String="Sales Doc."/>
            </Annotations>
