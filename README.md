sap.ui.define([
    ...
    "sap/m/MessageToast",
    "sap/base/util/uid"  // Import for UUID generation
], function (PageController, MessageToast, uid) {
    "use strict";
    return PageController.extend("com.example.weighingsessionwizard.controller.CustomPage", {
        ...
        _onObjectMatched: function () {
            ...
            var oNewContext = oListBinding.create({
                SessionId: uid()  // Generate unique SessionId to avoid duplicate key; adjust to your key field(s)
            }); // Create new entity context with initial key
