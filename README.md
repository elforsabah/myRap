...
*          The conditions are reported separately: a bare
*          "not configured" message tells the dispatcher nothing.
*----------------------------------------------------------------------*
  ...
  ELSEIF ls_cfg-active <> abap_true.
...
*----------------------------------------------------------------------*
  ...
  IF sy-subrc <> 0 OR ls_cfg-active is INITIAL
