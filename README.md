METHOD createtour.
  ...
  LOOP AT keys ASSIGNING FIELD-SYMBOL(<key>)
    ...
    SELECT tour_template AS tour_template ,
           date_start    AS start_date
      FROM /plce/tpdtour
      WHERE tour_template = @<group>-template
        AND date_start    BETWEEN @lv_first_date AND @lv_last_date
      INTO TABLE @lt_db_exist.

    INSERT LINES OF lt_db_exist INTO TABLE lt_exist.
