METHOD touranbmsfreigeben.
    ...
    "=======================================================================
    " CONFIG — read from ZTOUR_BMS_CFG
    "=======================================================================
    ...
    "           sdaufnr + sdposnr give the exact SD billing position
    "           for this specific container service
    "=======================================================================
    ...
    LOOP AT lt_tours INTO DATA(ls_tour).
      ...
      LOOP AT lt_asgmts INTO DATA(ls_asgmt)
        ...
        " 6e Positions
        "    Kept empty until BMS confirms valid OptiAwiPositionType enum values
        "    and the positionType mapping from SD item categories is agreed
        ...
        "    EWA internal order number is preferred; SD contract number as
        "    fallback if ordernr is not populated; smaufnr as last resort
        DATA(lv_order_ref) = COND string(
          WHEN ls_ewa-ordernr IS NOT INITIAL THEN |{ ls_ewa-ordernr }|
        ...
        "=====================================================================
        " STEP 7 — Serialize + patch field names that differ from ABAP naming
        "          /UI2/CL_JSON serializes null for initial numeric fields —
        "          replace itemPrice:null with 0 to satisfy BMS validation
        "=====================================================================
        ...
        "          BMS returns 200 OR 201 — both are treated as success
        "=====================================================================
