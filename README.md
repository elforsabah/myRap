...
{
  create;
  field ServiceStatus;          // changes frequently
  field PlanningStatus;         // changes during planning
  field ServicePriority;        //  might change
  field RequestedDate;          // changes when rescheduling
  field EarliestDate;           // changes when rescheduling
  field LatestDate;             //  changes when rescheduling
}
