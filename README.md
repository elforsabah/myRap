METHOD anlageaendern.
  ...
  DATA: lt_ext_create    TYPE TABLE FOR CREATE /plce/r_pdservice\_extcustom,
        ...
        " ✅ Declare tour failed/reported at top to avoid inline scope issues
        lt_tour_failed   TYPE TABLE FOR FAILED IMPORT /plce/r_pdtour~generategeoroute,
        lt_tour_reported TYPE TABLE FOR REPORTED IMPORT /plce/r_pdtour~generategeoroute.
  ...
  IF lt_extwr_update IS NOT INITIAL.
    ...
    " ✅ NEW: Success message for plant_location update
  ...
  IF lt_ext_update IS NOT INITIAL.
    ...
    ELSE.
      ...
      " ---------------------------------------------------------------------
      " ✅ FIX 2: Tour recalculation - properly structured
      " Only enters inner blocks when lt_tour_uuids is NOT initial
      " ---------------------------------------------------------------------
      IF lt_services IS NOT INITIAL.
        ...
        " ✅ FIX: Everything tour-related is INSIDE this check
        IF lt_tour_uuids IS NOT INITIAL.
          ...
          " ✅ FIX: Use pre-declared variables (not DATA() inline)
          MODIFY ENTITIES OF /plce/r_pdtour
            ENTITY tour
              EXECUTE generategeoroute FROM lt_tour_keys
            FAILED lt_tour_failed      " ✅ Pre-declared - no scope issues
            REPORTED lt_tour_reported. " ✅ Pre-declared - no scope issues

          " ✅ FIX: This check now only runs when tours were actually processed
